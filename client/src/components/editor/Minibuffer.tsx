...
export default function Minibuffer({
  ...
  const commands: MinibufferCommand[] = useMemo(() => {
    const cmds: MinibufferCommand[] = [
      ...
      { id: "epic-search", label: "epic-search", hint: "Search across all activities", action: () => { setMode("shell"); setQuery("epic search "); setShellOutput(""); } },
      ...
      { id: "epic-menu-crawl", label: "epic-menu-crawl", hint: "Auto-crawl Epic menus (vision AI)", action: () => { setMode("shell"); setQuery("epic menu-crawl "); setShellOutput(""); } },
