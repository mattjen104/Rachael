...
export function useRuntime() {
  return useQuery<{ active: boolean; lastTick: string | null; programs: Array<{ name: string; status: string; lastRun: string | null; nextRun: string | null; lastOutput: string | null; error: string | null; iteration: number }>; budget?: { used: number; budget: number; remaining: number; percentUsed: number; estimatedCostToday: number }; phantom?: { configured: boolean; available: boolean; lastChecked: string; latencyMs?: number; version?: string; error?: string } }>({
